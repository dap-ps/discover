...
export const connectWalletAction = createStandardAction(ActionTypes.CONNECT_WALLET)<boolean>();
export const disconnectWalletAction = createStandardAction(ActionTypes.DISCONNECT_WALLET)<boolean>();
